...
exports.expressions = function () {
  ...
  {"nom" : "Produit de deux lettres identiques",
   "conv": [],
   "expr": [P,a,a]},
  {"nom" : "Produit d’un nombre et de deux lettres",
   "conv": [],
   "expr": [P,2,a,b]}, // pour 2 pi R
  {"nom" : "Produit d’un nombre et du carré d’une lettre",
   "conv": [],
   "expr": [P,2,[C,a]]}, // pour pi R²
  {"nom" : "Produit d’une lettre et du carré d’une lettre",
   "conv": [],
   "expr": [P,a,[C,b]]}, // pour pi R²
  ...
  {"nom" : "Quotient de lettres",
   "conv": [],
   "expr": [Q,a,b]},
  {"nom" : "Quotient de la somme d’une lettre et d’un nombre par un nombre",
   "conv": [],
   "expr": [Q,[S,a,1],2]},
  {"nom" : "Quotient de la différence d’une lettre et d’un nombre par un nombre",
   "conv": [],
   "expr": [Q,[D,a,1],2]},
  ...
  {"nom" : "Opposé",
   "conv": [],
   "expr": [O,a]},
  {"nom" : "Racine d’un nombre",
   "conv": [],
   "expr": [R,1]},
  {"nom" : "Racine d’une lettre",
   "conv": [],
   "expr": [R,a]},
  {"nom" : "Produit d’une somme avec un nombre",
   "conv": [Pa],
   "expr": [P,[S,1,2],3]},
  {"nom" : "Produit d’une différence avec un nombre",
   "conv": [Pa],
   "expr": [P,[D,1,2],3]},
  ...
  {"nom" : "Produit d’un nombre avec une différence",
   "conv": [Pa],
   "expr": [P,1,[D,a,2]]},
  {"nom" : "Somme d’un nombre avec un produit de nombres",
   "conv": [MD,X],
   "expr": [S,1,[P,2,3]]},
  ...
  {"nom" : "Différence entre un nombre et l’opposé d’une lettre",
   "conv": [Pa],
   "expr": [D,1,[O,a]]},
  {"nom" : "Différence d’un nombre avec un produit de nombres",
   "conv": [MD,X],
   "expr": [D,1,[P,2,3]]},
  {"nom" : "Différence entre multiple et nombre",
   "conv": [MD,X],
   "expr": [D,[P,1,a],2]},
  {"nom" : "Somme d’une différence de nombres avec un nombre",
   "conv": [],
   "expr": [S,[D,1,2], 3]},
  {"nom" : "Différence d’un nombre avec une somme de nombres",
   "conv": [],
   "expr": [D,1,[S,2,3]]},
  ...
  {"nom" : "Carré d’une somme de lettres",
   "conv": [Pa],
   "expr": [C,[S,a,b]]},
  {"nom" : "Carré d’une différence entre une lettre et un nombre",
   "conv": [Pa],
   "expr": [C,[D,a,1]]},
  ...
  {"nom" : "Racine du carré",
   "conv": [],
   "expr": [R,[C,a]]},
  {"nom" : "Carré de la racine",
   "conv": [],
   "expr": [C,[R,a]]},
  {"nom" : "Somme de deux carrés",
   "conv": [El],
   "expr": [S,[C,a],[C,b]]},
  {"nom" : "Somme de deux produits de nombres",
   "conv": [],
   "expr": [S,[P,1,2],[P,3,4]]},
  {"nom" : "Produit de la somme de deux produits de nombres par un nombre",
   "conv": [],
   "expr": [P,[S,[P,1,2],[P,3,4]],5]},
  {"nom" : "Différence du carré d’une lettre avec le carré d’un nombre",
   "conv": [El],
   "expr": [D,[C,a],[C,1]]},
  {"nom" : "Différence de deux carrés",
   "conv": [El],
   "expr": [D,[C,a],[C,b]]},
  {"nom" : "Racine de la somme de deux nombres",
   "conv": [El],
   "expr": [R,[S,1,2]]},
  {"nom" : "Racine de la somme de deux lettres",
   "conv": [El],
   "expr": [R,[S,a,b]]},
  {"nom" : "Racine de la différence de deux lettres",
   "conv": [El],
   "expr": [R,[D,a,b]]},
  {"nom" : "Racine de la somme de deux carrés",
   "conv": [El],
   "expr": [R,[S,[C,a],[C,b]]]},
  {"nom" : "Somme de deux racines d’un nombre",
   "conv": [],
   "expr": [S,[R,1],[R,2]]},
  {"nom" : "Somme de deux racines d’une lettre",
   "conv": [],
   "expr": [S,[R,a],[R,b]]},
  {"nom" : "Produit d’un nombre avec la racine d’un nombre",
   "conv": [],
   "expr": [P,2,[R,3]]},
  {"nom" : "Produit de deux racines",
   "conv": [],
   "expr": [P,[R,a],[R,b]]},
  {"nom" : "Quotient de deux racines",
   "conv": [],
   "expr": [Q,[R,a],[R,b]]},
  {"nom" : "Racine d’un produit de deux lettres",
   "conv": [],
   "expr": [R,[P,a,b]]},
  {"nom" : "Racine d’un quotient de deux lettres",
   "conv": [],
   "expr": [R,[Q,a,b]]}, // pour sqrt{A/pi},
  {"nom" : "Différence entre un produit d’un truc avec un nombre, et un nombre",
   "conv": [],
   "expr": [D,[P,[S,1,[P,2,3]],4],5]},
  //1+2-(3times4+5)times6
  {"nom" : "Différence entre une somme et le produit d’un truc par un nombre",
   "conv": [],
   "expr": [D,[S,1,2],[P,[S,[P,3,4],5],6]]},
  {"nom" : "Quotient de la racine d’une somme par la racine d’un produit",
   "conv": [],
   "expr": [Q,[R,[S,a,b]],[R,[P,c,d]]]},
  ...
  {"nom" : "Différence entre le carré d’une somme et un nombre",
   "conv": [Pa,El],
   "expr": [D,[C,[S,a,1]],2]},
  {"nom" : "Produit d’une somme avec une différence (entre une même lettre et un nombre)",
   "conv": [Pa,X],
   "expr": [P,[S,a,1],[D,a,2]]},
  {"nom" : "Produit d’une différence avec une somme",
   "conv": [Pa,X],
   "expr": [P,[D,a,b],[S,c,d]]},
  {"nom" : "Produit d’une somme avec une différence",
   "conv": [],
   "expr": [P,[S,a,b],[D,c,d]]}, // pour dans l’autre sens
  {"nom" : "Développement du carré d’une somme, en plus souple",
   "conv": [],
   "expr": [S,[C,a],[P,2,b,c],[C,d]]}, // pour id rem carré d’une somme
  {"nom" : "Développement du carré d’une différence, en plus souple",
   "conv": [],
   "expr": [S,[D,[C,a],[P,2,b,c]],[C,d]]}, // pour id rem carré d’une diff
  {"nom" : "Produit d’une somme d’une produit avec un nombre, avec une différence entre une lettre et un nombre",
   "conv": [],
   "expr": [P,[S,[P,2,a],3],[D,b,4]]},
  ...
  {"nom" : "Somme d’une multiple de carré et d’un nombre",
   "conv": [El,X],
   "expr": [S,[P,1,[C,a]],a]},
  {"nom" : "Différence entre un nombre et le produit d’un nombre par un carré",
   "conv": [],
   "expr": [D,1,[P,2,[C,a]]]},
  ...
  {"nom" : "Quotient d’une somme et d’une différence",
   "conv": [F],
   "expr": [Q,[S,a,1],[D,a,2]]},
  {"nom" : "Quotient de la somme d’un carré avec un nombre par un nombre",
   "conv": [],
   "expr": [Q,[S,[C,a],1],2]},
